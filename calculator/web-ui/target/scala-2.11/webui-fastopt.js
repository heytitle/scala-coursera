...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var jsx$1 = new $c_Lcalculator_Calculator$$anonfun$3().init___sci_Map(namedExpressions);
  var this$1 = $m_sci_Map$();
  var res = $as_sci_Map(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$1)));
  return res
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var s = x3.name$2;
      var ref = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(s, references);
      ...
      var jsx$1 = this.eval__Lcalculator_Expr__sci_Map__D(a, references$1);
      var references$1$1 = references;
      return (jsx$1 + this.eval__Lcalculator_Expr__sci_Map__D(b, references$1$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      var references$1$2 = references;
      var jsx$2 = this.eval__Lcalculator_Expr__sci_Map__D(a$2, references$1$2);
      var references$1$3 = references;
      return (jsx$2 - this.eval__Lcalculator_Expr__sci_Map__D(b$2, references$1$3))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      var references$1$4 = references;
      var jsx$3 = this.eval__Lcalculator_Expr__sci_Map__D(a$3, references$1$4);
      var references$1$5 = references;
      return (jsx$3 * this.eval__Lcalculator_Expr__sci_Map__D(b$3, references$1$5))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      var references$1$6 = references;
      var jsx$4 = this.eval__Lcalculator_Expr__sci_Map__D(a$4, references$1$6);
      var references$1$7 = references;
      return (jsx$4 / this.eval__Lcalculator_Expr__sci_Map__D(b$4, references$1$7))
    } else {
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var solution = new $c_Lcalculator_Var().init___F0(expr);
  var delta$2 = this.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a, b, c);
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      var x1 = $uD(delta$1.apply__O());
      if ((x1 >= 0)) {
        var x = $uD(delta$1.apply__O());
        var adj = ($uD($g["Math"]["sqrt"](x)) / (2 * $uD(a$2.apply__O())));
        var first = ((-$uD(b$2.apply__O())) / (2 * $uD(a$2.apply__O())));
        var array$1 = [(first - adj), (first + adj)];
  ...
  $c_Lcalculator_Signal.prototype.update__F0__V.call(solution, expr$1);
  return solution
});
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var remain = new $c_Lcalculator_Var().init___F0(expr);
  ...
  $c_Lcalculator_Signal.prototype.update__F0__V.call(remain, expr$1);
  return remain
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainigCharsCount) {
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    return "green"
  }));
  var col = new $c_Lcalculator_Var().init___F0(expr);
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainigCharsCount$1) {
    return (function() {
      var x1 = $uI(remainigCharsCount$1.apply__O());
      switch (x1) {
        default:
  ...
  $c_Lcalculator_Signal.prototype.update__F0__V.call(col, expr$1);
  return col
});
...
/** @constructor */
var $c_Lcalculator_Calculator$$anonfun$3 = (function() {
  $c_sr_AbstractFunction1.call(this);
  this.refs$1$f = null
});
$c_Lcalculator_Calculator$$anonfun$3.prototype = new $h_sr_AbstractFunction1();
$c_Lcalculator_Calculator$$anonfun$3.prototype.constructor = $c_Lcalculator_Calculator$$anonfun$3;
/** @constructor */
var $h_Lcalculator_Calculator$$anonfun$3 = (function() {
  /*<skip>*/
});
$h_Lcalculator_Calculator$$anonfun$3.prototype = $c_Lcalculator_Calculator$$anonfun$3.prototype;
$c_Lcalculator_Calculator$$anonfun$3.prototype.apply__O__O = (function(v1) {
  return this.apply__T2__T2($as_T2(v1))
});
$c_Lcalculator_Calculator$$anonfun$3.prototype.init___sci_Map = (function(refs$1) {
  this.refs$1$f = refs$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$3.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, v$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(v$1.apply__O()), arg$outer.refs$1$f)
      })
    })(this, v));
    $c_Lcalculator_Signal.prototype.update__F0__V.call(sig, expr$1);
    return new $c_T2().init___O__O(k, sig)
  } else {
    throw new $c_s_MatchError().init___O(x$1)
  }
});
var $d_Lcalculator_Calculator$$anonfun$3 = new $ClassTypeData({
  Lcalculator_Calculator$$anonfun$3: 0
}, false, "calculator.Calculator$$anonfun$3", {
  Lcalculator_Calculator$$anonfun$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lcalculator_Calculator$$anonfun$3.prototype.$classData = $d_Lcalculator_Calculator$$anonfun$3;
/** @constructor */
